...
export function createToken(user) {
    return jwt.sign({ id: user.id }, process.env.JWT_SECRET as Secret, { expiresIn: '1d' });
}
...
module.exports = { createToken, setTokenCookie, generateRandomString, fetchTokens, refreshToken };